...
import com.kunfei.bookshelf.view.fragment.LauncherFragment;
...
public class MainActivity extends BaseTabActivity<MainContract.Presenter> implements MainContract.View, BookListFragment.CallbackValue {
    ...
    protected List<Fragment> createTabFragments() {
        ...
        LauncherFragment launcherFragment = null;
        for (Fragment fragment : getSupportFragmentManager().getFragments()) {
            if (fragment instanceof BookListFragment) {
                ...
                launcherFragment = (LauncherFragment) fragment;
            }
        }
        ...
        return Arrays.asList(bookListFragment, launcherFragment);
    }
    ...
    private void initTabLayout() {
        ...
        for (int i = 0; i < mTlIndicator.getTabCount(); i++) {
            ...
            */
            View view = tabFragmentPageAdapter.getTabView(this, i);
            ImageView iv = view.findViewById(R.id.iv_header);
            TextView tv = view.findViewById(R.id.tv_header);
            if (i == 0) {
                iv.setImageResource(R.drawable.book_closed);
                tv.setText("Book");
            } else if (i == 1) {
                iv.setImageResource(R.drawable.all_apps);
                tv.setText("Apps");
            }
        ...
        mTlIndicator.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                im.setVisibility(View.VISIBLE);
                */
                android.util.Log.d("wlDebug", "position = " + tab.getPosition());
